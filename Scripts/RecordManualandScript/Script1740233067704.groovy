...
WebUI.setText(findTestObject('Object Repository/Manual and Script mode/Page_Sign In/input_SIGN IN_UserData.UserID'), GlobalVariable.username)
...
WebUI.click(findTestObject('Manual and Script mode/Page_Electrode Inward/a_Hi Welcome Umar Farook'))

WebUI.click(findTestObject('Manual and Script mode/Page_Electrode Inward/a_Sign Out'))
